...
class ENV():
    ...
    def get_frame(self,ALL=False):
        ...
        if done:
            ...
            print("average_rewards: %f" % (self.cumulative_rewards / self.total_steps))
            self.episode_step_average_rewards.append(self.cumulative_rewards / self.total_steps)
    ...
    def done(self,world_state):
        ...
        if self.total_steps >= 500 or self.cumulative_rewards >= 200:
            ...
            if world_state.is_mission_running:
                ...
                for i in range(1):
                    ...
                    time.sleep(0.04)
            self.cumulative_rewards = max(self.wool * 50 + self.apple * 50 + self.stone * 100, self.cumulative_rewards)
