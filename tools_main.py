...
from task_xml import tools_stone_missionXML, tools_sheep_missionXML
from model import DQN, Dueling_DQN
from tools_learn import DQNAgent, OptimizerSpec
from utils.schedules import *
from utils.tools_minecraft_wrappers import ENV
...
missionXML_stone = tools_stone_missionXML
missionXML_sheep = tools_sheep_missionXML

validate = True
my_mission_stone = MalmoPython.MissionSpec( missionXML_stone, validate )
my_mission_sheep = MalmoPython.MissionSpec( missionXML_sheep, validate )
my_mission = [ my_mission_stone, my_mission_sheep]
